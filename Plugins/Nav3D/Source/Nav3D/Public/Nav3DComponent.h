...
public:
	...
	static float HeuristicScore(ANav3DVolume* Volume, const FNav3DOctreeEdge StartEdge, const FNav3DOctreeEdge TargetEdge, const FNav3DPathFindingConfig Config);
	...
	static void ExecutePathFinding2(ANav3DVolume* Volume, const FNav3DOctreeEdge& StartEdge, const FNav3DOctreeEdge& TargetEdge, const FVector& StartLocation, const FVector& TargetLocation, FNav3DPathFindingConfig Config, FNav3DPath& Path, float AbortTime, bool& HasAborted);
