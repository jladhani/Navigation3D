...
DECLARE_DELEGATE_RetVal_OneParam(bool, IsOccludedDelegate, const FBox&)
...
public:
	...
	float CachedGenerationTime = 0.f;
	...
	IsOccludedDelegate IsOccludedDel;
	...
	void GetLeafOcclusionBoxes(TArray<FBoxCenterAndExtent>& out);
#endif

#if WITH_EDITOR
	void UpdateVolume();
	void UpdateVolume2(UWorld* world);
#endif
